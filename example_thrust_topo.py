...
plt.plot(total_stress[0, :], "-b", linewidth=LINE_WIDTH, label=r"$\sigma_{xx}$")
plt.plot(total_stress[1, :], "--b", linewidth=LINE_WIDTH, label=r"$\sigma_{yy}$")
plt.plot(total_stress[2, :], "-.b", linewidth=LINE_WIDTH, label=r"$\sigma_{xy}$")
